...
def main():
    ...
    with st.sidebar:
        ...
        # Upload Documents Section in Sidebar
    ...
    if not st.session_state.documents_processed:
        if st.session_state.vector_store:
            ...
            if count > 0:
                ...
                # Upload Section in Main Content Area
                st.markdown("""
                <div style="text-align: center; margin-bottom: 2rem;">
                    <h2 style="color: #667eea; margin: 0 0 0.5rem 0; font-size: 2.5rem; font-weight: 800;">🚀 Get Started!</h2>
